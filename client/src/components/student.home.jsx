...
const StudentHome = () => {
    ...
    useEffect(() => {
        const fetchSchedule = async () => {
            ...
            let history=[]
            Object.keys(api_hist.data).forEach(h=>history.push({requestID: h, date: api_hist.data[h].date, room:api_hist.data[h].room, slot: api_hist.data[h].slot, status: api_hist.data[h].status  }))
